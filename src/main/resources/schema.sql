...
ALTER TABLE public.enterprise ALTER COLUMN id SET DEFAULT NEXT VALUE FOR public.enterprise_id_seq;
...
ALTER TABLE public.equipment ALTER COLUMN id SET DEFAULT NEXT VALUE FOR public.equipment_id_seq;
...
ALTER TABLE public.factory ALTER COLUMN id SET DEFAULT NEXT VALUE FOR public.factory_id_seq;
...
ALTER TABLE public.process ALTER COLUMN id SET DEFAULT NEXT VALUE FOR public.process_id_seq;
...
ALTER TABLE public.product ALTER COLUMN id SET DEFAULT NEXT VALUE FOR public.product_id_seq;
...
ALTER TABLE public.product_keyprocess ALTER COLUMN id SET DEFAULT NEXT VALUE FOR public.product_keyprocess_id_seq;
...
ALTER TABLE public.productstep ALTER COLUMN id SET DEFAULT NEXT VALUE FOR public.step_id_seq;
...
ALTER TABLE public.enterprise_keyprocess_equipment
...
ALTER TABLE public.enterprise_product_volume
...
ALTER TABLE public.factory_product
...
ALTER TABLE public.product_keyprocess
...
ALTER TABLE public.productstep

...
--
-- Data for Name: productstep; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.productstep VALUES (1, 1, 1, '线束装配');
INSERT INTO public.productstep VALUES (2, 1, 2, 'PCBA');
INSERT INTO public.productstep VALUES (3, 1, 3, '总成装配');


--
-- Data for Name: product_keyprocess; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.product_keyprocess VALUES (1, 1, 1, true);
INSERT INTO public.product_keyprocess VALUES (2, 1, 2, false);
INSERT INTO public.product_keyprocess VALUES (3, 2, 3, false);
INSERT INTO public.product_keyprocess VALUES (4, 2, 4, true);
INSERT INTO public.product_keyprocess VALUES (5, 3, 5, false);
INSERT INTO public.product_keyprocess VALUES (6, 3, 6, true);
...
ALTER SEQUENCE public.enterprise_id_seq RESTART WITH 2;
...
ALTER SEQUENCE public.equipment_id_seq RESTART WITH 8;
...
ALTER SEQUENCE public.factory_id_seq RESTART WITH 1;
...
ALTER SEQUENCE public.process_id_seq RESTART WITH 6;
...
--
-- Name: product_keyprocess_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

ALTER SEQUENCE public.product_keyprocess_id_seq RESTART WITH 6;
...
ALTER SEQUENCE public.step_id_seq RESTART WITH 3;
